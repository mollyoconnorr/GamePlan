...
public class AdminService {
     ...
     */
    public List<com.carroll.gameplan.dto.response.AdminUserResponse> listUsers() {
     ...
     */
    public com.carroll.gameplan.dto.response.AdminUserResponse createPendingStudent(CreateUserRequest request) {
     ...
     */
    public com.carroll.gameplan.dto.response.AdminUserResponse updateUserRole(Long userId, String requestedRole) {
