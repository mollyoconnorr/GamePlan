...
export default function DateTimeRangePicker(props: DateTimeRangePickerProps) {
    ...
    const baseEndTime = props.timeWindowEnd ?? props.endTime;
    const baseTimeOptions = useMemo(() => {
        return buildTimeOptions(effectiveStartTime, baseEndTime, props.timeStep);
    }, [baseEndTime, effectiveStartTime, props.timeStep]);
    ...
    }, [props.firstDate, props.numDays, todayKey, props.scheduleBlocks]);
